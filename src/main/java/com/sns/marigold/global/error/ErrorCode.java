...
public enum ErrorCode {
  ...
  FILE_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE, "FILE_TOO_LARGE", "파일 또는 요청의 최대 업로드 용량을 초과했습니다."),
  ...
  AUTH_RECENT_AUTH_REQUIRED(
      HttpStatus.FORBIDDEN, "AUTH_RECENT_AUTH_REQUIRED", "Recent authentication is required."),
  ...
  ADOPTION_POST_DELETED(HttpStatus.GONE, "ADOPTION_POST_DELETED", "삭제된 게시글입니다."),
  ADOPTION_POST_IMAGE_INVALID(
      HttpStatus.BAD_REQUEST, "ADOPTION_POST_IMAGE_INVALID", "입양 게시글 이미지 정보가 올바르지 않습니다."),
