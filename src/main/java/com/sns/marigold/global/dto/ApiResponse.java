...
public class ApiResponse<T> {
    ...
    // -- 필드 에러 응답 --
    public static <T> ApiResponse<T> error(HttpStatus status, String message, List<? extends ErrorDetail> errors) {            
        return new ApiResponse<>(false, LocalDateTime.now(), status.value(), message, null, null, errors);
    }
