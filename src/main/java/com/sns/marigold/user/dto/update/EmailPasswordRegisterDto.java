...
@Schema(description = "이메일/비밀번호 로그인 수단 등록 요청")
@Getter
@NoArgsConstructor
@AllArgsConstructor
public class EmailPasswordRegisterDto {

  @Schema(description = "등록할 이메일", example = "user@example.com")
  @Email(message = "이메일 형식이 올바르지 않습니다.")
  @NotBlank(message = "이메일은 필수입니다.")
  private String email;

  @Schema(description = "등록할 비밀번호. 8자 이상", example = "password123!", format = "password")
